...
- これは、私を気違いにさせないためであり、それぞれのケースで出力される、より重要な実際の文字列に多くの注意を向けさせるためです。多くの例で、実際にコードを動かすと、alotofwordsallsmusheduptogetherononelineのような結果になります。無視してください。g
...
- リファレンスを解く方法
  - ブレース
  - アロー演算子
- オブジェクト志向の場合、オブジェクト->メソッド() という使われ方g
